    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 flex items-center justify-center p-4">
            <div className="flex flex-col items-center space-y-8">
                ...
                <div className={`w-32 h-32 ${light === 'red' ? colors[light] : colors['gray']
                    } rounded-full`}></div>

                <div className={`w-32 h-32 ${light === 'yellow' ? colors[light] : colors['gray']
                    } rounded-full`}></div>
                <div className={`w-32 h-32 ${light === 'green' ? colors[light] : colors['gray']
                    } rounded-full`}></div>
